 ...
 */
public class ORecyclerViewFooter extends LinearLayout {
    ...
    private OLoadView lfrecyclerview_footer_loadview;

    public ORecyclerViewFooter(Context context) {
        super(context);
        initView(context);
    }

    public ORecyclerViewFooter(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
    ...
    private void initView(Context context) {
        mContext = context;
        LinearLayout moreView = (LinearLayout) LayoutInflater.from(mContext).inflate(R.layout.o_recyclerview_footer, null);
        addView(moreView);
        ...
        lfrecyclerview_footer_loadview = (OLoadView) moreView.findViewById(R.id.lfrecyclerview_footer_loadview);
    }

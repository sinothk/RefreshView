 ...
 */
public class ORecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    public void setRecyclerViewFooter(ORecyclerViewFooter recyclerViewFooter) {
        this.recyclerViewFooter = recyclerViewFooter;
    }

    public void setRecyclerViewHeader(ORecyclerViewHeader recyclerViewHeader) {
    ...
    public ORecyclerViewAdapter(Context context, RecyclerView.Adapter adapter) {
        mContext = context;
...
//            });
        ...
        if (itemLongClickListener != null) {
            holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                @Override
                public boolean onLongClick(View view) {
                    itemLongClickListener.onLongClick(po);
                    return true;
                }
            });
        }
